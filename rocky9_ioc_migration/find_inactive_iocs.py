"""
    ...
    ['4jawSlit', 'Alcatel-turbo', 'CHB-detector', 'DS335', 'MicosHP140', 'NewportAgilis', 'PS350', 'RGAs', 'TE-tech', 'acqiris', 'agilent5322.backup', 'arlyn-upscale', 'authTest', 'autoEncoder', 'beckhoffIO', 'bhc-solenoid', 'bldMonitor', 'bme280', 'caen', 'cam-ipimb', 'clCam', 'cole-parmer', 'coolershaker', 'cr_test', 'evrTest', 'gas-regulator', 'generic_snmp', 'generic_streamdevice', 'geoBrick', 'inficonMPH', 'innovasonic203', 'keysight53200', 'lauda_VC2000', 'lusiTest', 'meanwell', 'mirror_dx', 'mmcCommunity', 'moveTogether', 'mse1650', 'newall-SHG-A2', 'orcaApp', 'pfeiffer', 'pgpEdt', 'pi-e517', 'pmcMotion', 'poe-inj', 'pyreos', 'rigolDS', 'rotSamplePlane', 'scripter', 'slowCam', 'softTest', 'sr570', 'srg3', 'srs-sim-cpsw', 'tdkLambdaGen', 'topas', 'tucsenCam', 'tuttifrutti', 'usbFLIRCam', 'vatPM5', 'xip_pp', 'ztec_scope']
"""
